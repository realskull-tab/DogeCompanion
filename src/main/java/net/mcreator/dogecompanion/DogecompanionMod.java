package net.mcreator.dogecompanion;
...
@Mod("dogecompanion")
public class DogecompanionMod {
	public static final Logger LOGGER = LogManager.getLogger(DogecompanionMod.class);
	public static final String MODID = "dogecompanion";

	public DogecompanionMod(IEventBus modEventBus) {
